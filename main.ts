  ...
  if (newEnemy.nameOfEnemy == "Zombi") {
    ...
    while (true) {
      ...
      if (answer3.action == "Attack") {
        console.log(
          `\n\t ${chalk.green.bold(
            `${newPlayer.nameOfPlayer}`
          )} attacked ${chalk.red.bold(newEnemy.nameOfEnemy)}\n`
        );
        // welcoming messeage
        ...
        if (randomNumber > 0) {
          ...
          console.log(
            `\n\t ${chalk.green.bold(
              `${newPlayer.nameOfPlayer} has left = ${newPlayer.hpOfPlayer}% (Hp)`
            )}\n`
          );
          console.log(
            `\n\t ${chalk.red.bold(
              `${newEnemy.nameOfEnemy} has left = ${newEnemy.hpOfEnemy}% (Hp)`
            )}\n`
          );
        }
        if (newPlayer.hpOfPlayer <= 0) {
          console.log(
            chalk.bgRed(
              `\n\t ${chalk.bold(
                `${newPlayer.nameOfPlayer} has lost the Game`
              )}\n`
            )
          );
          ...
          if (newEnemy.hpOfEnemy <= 0) {
            console.log(
              chalk.bgGreen(
                `\n\t ${chalk.bold(
                  `${newPlayer.nameOfPlayer} has Won the Game`
                )} \n`
              )
            );
            break;
      ...
      if (answer3.action == "HP") {
        ...
        console.log(
          "\n\t",
          chalk.green.bold(
            `${newPlayer.nameOfPlayer} your HP is increased = ${newPlayer.hpOfPlayer} %\n`
          )
        );
      }
